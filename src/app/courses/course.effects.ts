...
import {AllCoursesLoaded, AllCoursesRequested, CourseActionTypes, CourseLoaded, CourseRequested, LessonsPageLoaded, LessonsPageCancelled} from './course.actions';
...
export class CourseEffects {
  ...
  loadAllCourses$ = this.actions$
    ...
    loadLessonsPage$ = this.actions$
      .pipe(
        ofType<AllCoursesRequested>(CourseActionTypes.LessonsPageRequested),
